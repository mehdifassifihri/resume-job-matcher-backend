"""
FastAPI routes and endpoints for the resume-job matcher - Basic version without authentication.
"""
import os
import tempfile
import shutil
...
app = FastAPI(
    title="AI Resume & Job Matcher — Basic API",
    description="AI-powered resume and job matching system with ATS validation",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
